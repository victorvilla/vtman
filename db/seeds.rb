...
tasks = Task.create([{video_title: "Lorem ipsum dolor sit amet", type_script: Task.type_scripts[:full],
  ...
  voice_talent_user_id: talents.to_a[0].id, guidespark_user_id: gs.to_a[0].id,
  ...
  voice_talent_user_id: talents.to_a[2].id, guidespark_user_id: gs.to_a[1].id,
  ...
  voice_talent_user_id: talents.to_a[3].id, guidespark_user_id: gs.to_a[2].id,
  ...
  voice_talent_user_id: talents.to_a[4].id, guidespark_user_id: gs.to_a[3].id,
